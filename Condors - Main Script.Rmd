...
library(terra)
library(ranger)
library(ecospat) # Conflict with biomod2, error: "Error: package or namespace load failed for ‘ecospat’: object ‘.transform_model.as.col’ is not exported by 'namespace:biomod2'"
# I'd be grateful for any way around
...
plot(gbi_vg_crd$decimalLatitude ~ gbi_vg_crd$decimalLongitude)
range(gbi_vg_crd$decimalLongitude)

  # Extract essential columns
  gbi_vg_crd <- gbi_vg$data[,c("decimalLongitude", "decimalLatitude", 
                             "coordinateUncertaintyInMeters", "occurrenceStatus")]
