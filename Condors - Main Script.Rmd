...
# 
# # Reading in environmental predictors (adjust path)
# predictors_condor <- rast("predictors_condor.tif")
# predictors_bear <- rast("predictors_bear.tif")
# predictors_puma <- rast("predictors_puma.tif")
# 
# predictors <- predictors_puma
# 
...
# pa_geo_bear  <- cbind(pa_geo_bear, extract(predictors_puma, pa_geo_bear[, c("x", "y")], ID = F))
# 
# # Removing NAs
# model_matrix_condor <- model_matrix_condor[complete.cases(model_matrix_condor),]
# summary(model_matrix_condor)
...
#   temp_mean_annual + I(temp_mean_annual^2) +
#   temp_range + I(temp_range^2) + 
#   prec_annual + I(prec_annual^2) + 
#   tree_cover + I(tree_cover^2) + 
#   pop_dens + I(pop_dens^2) + 
#   aspect + I(aspect^2) + 
#   slope + I(slope^2) + 
#   water_bodies + I(water_bodies^2)
# 
# form_glm_puma <- Presence ~
#   temp_mean_annual + I(temp_mean_annual^2) +
#   temp_range + I(temp_range^2) + 
#   prec_annual + I(prec_annual^2) + 
#   prec_driest_month + I(prec_driest_month^2) + 
#   tree_cover + I(tree_cover^2) + 
#   pop_dens + I(pop_dens^2) + 
#   aspect + I(aspect^2) + 
#   slope + I(slope^2) + 
...
# 
# form_rf_condor <- Presence ~ temp_mean_annual + temp_range + prec_annual + tree_cover + pop_dens +
#   aspect + slope + water_bodies
#   
# form_rf_puma <- Presence ~ temp_mean_annual + temp_range + prec_annual + prec_driest_month + tree_cover + pop_dens +
#   aspect + slope + water_bodies
# 
# form_rf_bear <- Presence ~ temp_mean_annual + temp_range + prec_annual + prec_driest_month + tree_cover + pop_dens +
#   aspect + slope + water_bodies
# 
# 
# ######################################################################################
...
############################################################################################
#The code above has been run, the files are stored in the repository, please don't run again but access the files directly (Manuel 10/05; 18:10)
############################################################################################
```
...
## Run for all species in excel sheet
