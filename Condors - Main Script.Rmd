...
species <- c("Vultur gryphus", "Puma concolor", "Tremarctos ornatus")
for(i in 1:length(species)){
  paste0("gbi_", species[i]) <- occ_search(scientificName = species[i], 
...
# I will run the code above now and send you the files, so don't run it (Manuel 6/4; 13:22)
...
library(terra) # Problem with installation
