...
lakes <- read_sf("Hydro_LAKES/Hydro_LAKES/sa_lakes.shp")%>% ### CHANGE PATH
  st_transform(st_crs(area))
rivers <- read_sf("Hydro_RIVERS/HydroRIVERS_v10_sa.shp")%>% ### CHANGE PATH
  st_transform(st_crs(area))
...
water<-rast("sa_water_1km_aea.tif") ### CHANGE PATH
...
setwd("Project/Polygon approach") ### CHANGE PATH
...
input_dir <- "Project/Polygon approach"  ### CHANGE PATH
