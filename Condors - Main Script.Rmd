...
The following chunk produces a set of random pseudo-absences. The data is stored in the Pseudo absences folder.

Generating geographically stratified pseudo-absences entailed to aggregate the 1x1km resolution DEM to a 10x10km resolution to keep computing times practicable. Furthermore, the stratification of the topography was implemented in classes of 100 meters.
...
plot(prec_wettest_month, axes=F)
