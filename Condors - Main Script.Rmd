...
The following script has been adapted from *Lyu et al., 2022. An integrated high-resolution mapping shows congruent biodiversity patterns of Fagales and Pinales*.
...
# Load polygon mapping functions from where you save these scripts
source("./range_fun.R")
