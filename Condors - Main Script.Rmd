...
## Chunk 6: Model Evaluation and Ensemble (Justine)
...
## Chunk 7: Creating projections (Tanja)
...
## Chunk 8: Polygon-based alternative approach (Manuel)
...
## Chunk 9: Down-scaling to Colombia; Comparison with PA-network (Manuel)

The following chunk acquires a shapefile for Colombia, projects it to ESRI:102033 and crops rasters to it.
