...
![](images/Predictors.jpg "Predictors")
...
1.  Correlation among predictors: we calculated all pairwise Pearson correlation coefficients in the predictor set. The follow plots visualize the correlation with first Condor, then Puma and then Bear.
    ...
    ![Predictors Condor](images/Predictors%20Condor.jpg "Predictors Condor"){width="316"}![Predictors Puma](images/Predictors%20Puma.jpg "Predictors Puma"){width="316"}

    ![Predictors Bear](images/Predictors%20Bear.jpg "Predictors Bear"){width="316"}

2.  The explanatory power of the predictors was calculated to decide which variables to use for each species.

    Condor:

    ![](images/Exp_power%20Condor.jpg "Exp_power Condor")

    Puma:

    ![](images/Exp_power%20Puma.jpg)

    Bear:

    ![](images/Exp_power%20Bear.jpg)
